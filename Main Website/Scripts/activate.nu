...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\asus\.virtualenvs\car-rental-system-4jT3KusX'
    let bin = 'Scripts'
    let path-sep = ';'
    ...
    let virtual-prompt = if ('car-rental-system' == '') {
...
alias deactivate = source 'C:\Users\asus\.virtualenvs\car-rental-system-4jT3KusX\Scripts\deactivate.nu'
